...
- Every file is measured as it is added (integrated loudness and true peak, EBU R128) and the page
  suggests the level that puts it on the level of the game's own stations, as far as the file's
  peak allows. "Use it" takes one suggestion; "Use suggested levels" takes them all.
